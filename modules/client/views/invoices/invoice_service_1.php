...
<div class="page flex-column">
    ...
    <div>&nbsp;</div>
    <div>Тариф на послуги центрального постачання холодної води - <?php echo $invoice->price_main; ?> за 1 куб.м (з ПДВ)</div>
    <div>Тариф на послуги центрального водовідведення холодної води - <?php echo $invoice->price_drain; ?> за 1 куб.м (з ПДВ)</div>
    <div>&nbsp;</div>
    <div class="note">
