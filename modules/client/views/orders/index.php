...
<div class="table">
    ...
    echo FrontendGrid::widget([
        'id' => 'orders',
        'cols' => ['80px', '80px', '80px', '100px', '100px', '50px'],
        'filterModel' => $model,
...
//        },
        'columns' => [
            [
                ...
                'format' => 'raw',
                'filterInputOptions' => ['placeholder' => $model->getAttributeLabel('request_id')],
                'value' => function ($data) {
                    $url = Url::to(['/client/preorders/view', 'id' => $data->request_id]);
                    return '<span class="mob-title">' . $data->getAttributeLabel('request_id') . ': </span><span class="mob-descr"><a data-pjax="0" class="cell-link" href="' . $url . '" target="_blank">' . $data->request_id . '</a></span>';
                },
            ],
            [
                'attribute' => 'number',
            ...
            [
                'attribute' => 'status_id',
                'format' => 'raw',
                'filter' => Orders::$filterStatusLabels,
