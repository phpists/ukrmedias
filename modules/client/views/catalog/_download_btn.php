...
<div class="dark_fond opac0" id="modal-download">
    ...
    <div class="modal" style="max-width:400px;">
        ...
        <div class="footer">
            <div>
                <a class="btn_default" href="<?php echo Url::to(['/client/data/download-xml', 'id' => $cat_id, 'ref' => getenv('REQUEST_URI')]); ?>">Скачати в XML</a>
            </div>
            <div>
                <a class="btn_default" href="<?php echo Url::to(['/client/data/download-excel', 'id' => $cat_id, 'ref' => getenv('REQUEST_URI')]); ?>">Скачати в Excel</a>
            </div>
        </div>
...
<div class="dark_fond opac0" id="modal-download-with-image">
    ...
    <div class="modal" style="max-width:400px;">
        ...
        <div class="footer">
            ...
            <div>
                <a class="btn_default" href="<?php echo Url::to(['/client/data/download-excel-photo', 'id' => $cat_id, 'ref' => getenv('REQUEST_URI')]); ?>">Скачати в Excel</a>
            </div>
        </div>
        <span id="js_upload_indicator" class="dn" style="padding:7px;"><?php echo \app\components\Icons::$loading; ?></span>
    </div>
