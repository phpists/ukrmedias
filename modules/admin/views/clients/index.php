        ...
        [
            ...
            'buttons' => [
                'users' => function ($url, $model, $key) {
                    return Html::a('<i class="fa fa-users"></i>', yii\helpers\Url::toRoute(['/admin/users/index', 'Users[client_id]' => $model->getTitle()]), ['class' => '', 'title' => 'користувачі', 'data-pjax' => 0]);
                },
