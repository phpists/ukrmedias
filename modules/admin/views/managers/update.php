...
<div class="row">
    <div class="col-sm-12 col-md-4">
        <?php echo $form->field($model, 'role_id')->dropDownList(Auth::$roleLabelsOwner); ?>
    </div>
    <div class="col-sm-12 col-md-4">
...
<div class="row">
    <div class="col-sm-12 col-md-8 col-lg-4">
        <?php
        echo $form->field($model, 'notify')->checkbox([
            'checked' => $model->notify,
            'label' => '<span class="badge border badge-pill col">' . $model->getAttributeLabel('notify') . ' <i class="fa fa-check"></i></span>',
        ]);
        ?>
    </div>
</div>
