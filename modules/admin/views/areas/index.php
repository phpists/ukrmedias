...
echo app\components\AdminGrid::widget([
    ...
    'columns' => [
        [
            ...
            'format' => 'raw',
            'filterInputOptions' => ['class' => 'form-control', 'placeholder' => $model->getAttributeLabel('search_region')],
        ],
        [
            'attribute' => 'title',
            'format' => 'raw',
            ...
            'buttons' => [
                ...
                'delete' => function ($url, $model, $key) {
                    return Html::a('<i class="fa fa-trash"></i>', $url, [
                                'title' => 'видалити',
                                'data-confirm-message' => 'Разом з районом будуть видалені пов`язані з ним населені пункти, вулиці, будинки, квартири, дані про споживання, рахунки, події та параметри для розрахунків. Після видалення будуть втрачені прив`язки Lora-пристроїв та приладів обліку.<br/>Ви підтверджуєте видалення району "<i>' . Html::encode($model->title) . '</i>"?',
                    ]);
                },
            ],
        ],
