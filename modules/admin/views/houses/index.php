            ...
            'buttons' => [
                ...
                'delete' => function ($url, $model, $key) {
                    return Html::a('<i class="fa fa-trash"></i>', $url, [
                                'title' => 'видалити',
                                'data-confirm-message' => 'Разом з будинком будуть видалені пов`язані з ним квартири, дані про споживання, рахунки, події та параметри для розрахунків. Після видалення будуть втрачені прив`язки Lora-пристроїв та приладів обліку.<br/>Ви підтверджуєте видалення будинку з адресою "<i>' . Html::encode($model->getTitle()) . '</i>"?',
                    ]);
                },
            ],
        ],
